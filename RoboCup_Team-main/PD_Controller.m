function [player_acceleration]=PD_Controller(player_x,player_y,player_speed,Kp,Kd,distance_to_ball,prev_distance_to_ball)
 % 初始化球员的速度inatialize the speed of the player
    d_distance_to_ball=prev_distance_to_ball-distance_to_ball;
    dt=0.15;
    player_acceleration = [0,0];
 % 计算PD控制器的输出，即球员的加速度 calculate acceleration
 ...
 % 设定球员移动的最大加速度 max acceleration
    max_acceleration = 1;   
    %max_speed=2;

  % 如果球员的加速度超过了最大加速度，则将其缩放到最大加速度 scale to max
